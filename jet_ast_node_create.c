...
jet_ast_node_ident* 
   jet_astn_ident_create(const char* ident) { return NULL;  }

jet_ast_node_lit* 
   jet_astn_lit_create(int lit_type, void* value) { return NULL;  }

jet_ast_node_block* 
   jet_astn_block_create(jet_list* node_list) { return NULL;  }

jet_ast_node_var_ref* 
   jet_astn_vref_create(jet_ast_node* var_binding_ident) { return NULL;  }

jet_ast_node_var_decl* 
   jet_astn_vdecl_create(
      jet_ast_node* binding_ident, 
      jet_ast_node* type_decl, 
      jet_ast_node* init_value) { return NULL;  }

jet_ast_node_type_decl*
   jet_astn_tdecl_create(
      jet_ast_node* type_ident, 
      size_t byte_size, 
      bool is_native) { return NULL;  }

jet_ast_node_func_decl* 
   jet_astn_fdecl_create(
      jet_ast_node* binding_ident,
      jet_list* ret_type_decls,
      jet_list* param_var_decls) { return NULL;  }
